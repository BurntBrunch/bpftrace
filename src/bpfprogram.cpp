...
void BpfProgram::relocateInsns()
{
  ...
  if (bytecode_.find(relsecname) != bytecode_.end())
  {
    ...
    {
      Elf64_Rel *rel = reinterpret_cast<Elf64_Rel *>(ptr);
      ...
      auto rel_offset = program_offset + rel->r_offset;
      ...
      Elf64_Sym *sym = &reinterpret_cast<Elf64_Sym *>(symtab.data())[relsym];
    ...
    bool need_text_rels = copied_text &&
